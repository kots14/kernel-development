...
.loop:
    ...
    call print__char    ; Otherwise print the character in AL
    jmp .loop           ; Loop to the next character
.done:
    ret                 ; Return from the print function

print__char:
    mov ah, 0eh          ; Mov 0eh into AH this is the BIOS service number for 
                        ; printing a character

    int 0x10            ; Call BIOS interrupt 0x10, which handles screen operations
    ret                 ; Return from the print__char function
